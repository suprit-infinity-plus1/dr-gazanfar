            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="assets/img/logo11.png" class="logo" alt="Logo">
                    </a>
                </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="error-box">
                        ...
                        <p>
                            ...
                            insensible sympathize boisterous regular inspiration.
                        </p>
                        <a class="btn btn-md btn-theme border" href="#"><i class="fas fa-angle-right"></i> Back
                            to Home</a>
                        <div class="search">
