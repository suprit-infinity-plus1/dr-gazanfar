            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="department_head"
                        value="{{ old('department_head', $treatment->department_head) }}"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <select name="status"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
                        <option value="1" {{ old('status', $treatment->status) == '1' ? 'selected' : '' }}>Active
                        </option>
                        <option value="0" {{ old('status', $treatment->status) == '0' ? 'selected' : '' }}>Inactive
                        </option>
                    </select>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="content" class="summernote">{{ old('content', $treatment->content) }}</textarea>
                </div>
            </div>
            ...
            <div class="border-t border-gray-100 pt-6 mt-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" name="seo_title" value="{{ old('seo_title', $treatment->seo_title) }}"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Meta Description</label>
                        <textarea name="meta_description" rows="3"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm">{{ old('meta_description', $treatment->meta_description) }}</textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Meta Keywords</label>
                        <input type="text" name="meta_keywords"
                            value="{{ old('meta_keywords', $treatment->meta_keywords) }}"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
                    </div>
                </div>
            </div>
