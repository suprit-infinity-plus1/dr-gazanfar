                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <textarea name="schema" rows="5"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm font-mono text-xs">{{ old('schema') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="cover_image" accept="image/*" required @change="fileChosen"
                            ...
                            <div class="mt-2">
                                ...
                                <input type="text" name="cover_image_alt" value="{{ old('cover_image_alt') }}"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm"
            ...
            function blogForm() {
                return {
                    ...
                    async updateCategory() {
                        ...
                        try {
                            const url =
                                `{{ url('admin/dashboard/blogs/categories/update') }}/${this.editingCategory.id}`;
