...
(function ($) {
    ...
    // Sticky Header Js (Robust Update)
    $(window).on('scroll', function () {
    ...
    // Ultra-Robust Close Listener (Delegated)
    $(document).on("click", "ul.nav>li>a, .overlay-screen, .close-side, .btn-close-sidebar", function () {
        $(".navbar-collapse").removeClass("show in on opened active");
        $(".overlay-screen").removeClass("opened");
        $(".fa-times, .fa-bars").parent().parent().find(".navbar-toggle").removeClass("fixed");
        // Also ensure the fa-times flips back if applicable
        $(".btn-close-sidebar i").addClass("fa-times").removeClass("fa-bars");
    });
